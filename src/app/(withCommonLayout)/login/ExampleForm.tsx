...
import { Label } from "@/components/ui/MyForm/aceternityUI/label";
...
export function SignupFormDemo() {
  ...
  return (
    ...
    <MyFormWrapper onSubmit={handleSubmit} className="flex flex-col gap-3 my-8">
        <div className="flex flex-col gap-4 md:gap-0 md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <MyFormInputAceternity name="firstName" label="First name" placeholder="Type First name" />
          <MyFormInputAceternity name="lastName" label="Last name" placeholder="Type Last name" />
        </div>
